...
{   
    public partial class mainForm : Form
    {
           ...
           switch(comboBox1.SelectedIndex)
            {
                ...
                case 1:
                    ...
                    orderBindingSource.DataSource = orderService.GetByOrderID(id);
                    break;
        ...
        private void buttonExportToHTML_Click(object sender, EventArgs e)
        {
            DialogResult result = saveFileDialog2.ShowDialog();
            if (result.Equals(DialogResult.OK))
            {
                String fileName = saveFileDialog2.FileName;
                orderService.exportToHtml(fileName);
            }
        }
    }
}
